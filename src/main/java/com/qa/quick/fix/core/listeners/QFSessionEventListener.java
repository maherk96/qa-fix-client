...
/**
 * Interface for listening to QuickFIX/J session-level events. 
 * Implementations of this interface can react to events such as session logon, logout, and message rejection.
 */
public interface QFSessionEventListener {
    ...
    /**
     * Called when an administrative message (e.g., a reject message) is received 
     * for a QuickFIX/J session, indicating a rejection.
     *
