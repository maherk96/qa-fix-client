...
/**
 * Interface for listening to incoming FIX application messages. Implementations of this interface
 * can process messages received from a QuickFIX/J session.
 */
public interface QFInboundMessageListener {
   ...
   * @param message The QuickFIX/J {@link Message} object representing the incoming application
   *     message.
   */
