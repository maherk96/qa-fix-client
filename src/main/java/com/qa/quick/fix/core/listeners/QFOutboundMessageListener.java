...
/**
 * Interface for listening to outgoing FIX application messages. Implementations of this interface
 * can process messages sent from a QuickFIX/J session.
 */
public interface QFOutboundMessageListener {
   ...
   * @param message The QuickFIX/J {@link Message} object representing the outgoing application
   *     message.
   */
