...
/**
 * Test FIX Acceptor for integration testing.
 * Simulates a FIX server that clients can connect to.
 */
@Slf4j
public class TestFixAcceptor implements Application, AutoCloseable {
    ...
    @Getter
    private final AtomicInteger logons = new AtomicInteger(0);
    
    @Getter
    private final AtomicInteger logouts = new AtomicInteger(0);
    
    @Getter
    private final AtomicInteger fromAppCount = new AtomicInteger(0);
